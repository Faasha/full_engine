...
Uses ECS for ownership/state compatibility and FlatWorld for
movement + render extraction hot paths.
"""
...
def run_probe(
    ...
    print(f"avg sync back: {(sync_total / ticks) * 1000.0:.4f} ms")
